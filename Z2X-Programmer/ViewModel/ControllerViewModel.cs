...
namespace Z2XProgrammer.ViewModel
{
    public partial class ControllerViewModel : ObservableObject
    {
        ...
        /// <summary>
        /// Opens the external controller window. This function is only supported on Windows.
        /// </summary>
        [RelayCommand]
        void OpenInExternalWindow()
        {
            ...
            {
                Logger.PrintDevConsole("ControllerViewModel.OpenInExternalWindow: " + ex.Message);
            }
