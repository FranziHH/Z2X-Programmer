...
![The locomotive list](./Assets/Z2X-Programmer-LocomotiveListOverview.png)

The locomotive list can be opened by clicking on the Z2X-Programmer icon the flyout menu.

![Open locomotive list](./Assets/Z2X-Programmer-LocomotiveListOpen.png)
...
![Configure the Z2X file folder](./Assets/Z2X-Programmer-LocomotiveListConfigureZ2XPath.png)
...
![Configure the train controller software](./Assets/Z2X-Programmer-LocomotiveListConfigureTrainController.png)
...
![Configure the train controller software](./Assets/Z2X-Programmer-LocomotiveListSelectLoco.png)
